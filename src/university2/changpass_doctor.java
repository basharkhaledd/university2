 ...
 * @author w
 */
public class changpass_doctor extends javax.swing.JFrame {

     login l = new login();
    Connection con=null;
    PreparedStatement p =null;
    ResultSet rst=null;
    public changpass_doctor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(479, 338));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!conpass.getText().equals("") && !newpass.getText().equals("") && !oldpass.getText().equals("") )
        {
            ...
            try {
                con=connect();
                p=con.prepareStatement("select password from doctor where id='"+user.getText()+"'");
                rst=p.executeQuery();
                rst.next();

                if(oldpass.getText().equals(rst.getString("password"))){
                    p=con.prepareStatement("update doctor set password='"+newpass.getText()+"' where id ='"+user.getText()+"'");
                    p.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(changpass_doctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new changpass_doctor().setVisible(true);
            }
        });
    }
